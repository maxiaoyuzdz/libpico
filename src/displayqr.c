...
/**
 * @brief Structure used for generating QR code output
 *
 * Opaque structure containing the private fields of the DisplayQR class.
 *
 * This is provided as the first parameter of every non-static function and 
 * stores the operation's context.
 * 
 * The structure typedef is in displayqr.h
 */
struct _DisplayQR {
	QRMODE qr_mode;
	void * mode_param;
