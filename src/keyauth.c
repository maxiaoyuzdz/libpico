...
/**
 * @brief Structure used to generate JSON for bootstrapping the authentication
 * process
 *
 * Opaque structure containing the private fields of the KeyAuth class.
 *
 * This is provided as the first parameter of every non-static function and 
 * stores the operation's context.
 * 
 * The structure typedef is in keyauth.h
 */
struct _KeyAuth {
	Json * json;
