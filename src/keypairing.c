...
/**
 * @brief Structure used to generate JSON for bootstrapping the pairing process
 *
 * Opaque structure containing the private fields of the KeyPairing class.
 *
 * This is provided as the first parameter of every non-static function and 
 * stores the operation's context.
 * 
 * The structure typedef is in keypairing.h
 */
struct _KeyPairing {
	Json * json;
